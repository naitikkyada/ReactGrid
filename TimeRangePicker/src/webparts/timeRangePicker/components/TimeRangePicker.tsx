...
export default class TimeRangePicker extends React.Component<ITimeRangePickerProps, {}> {
  public render(): React.ReactElement<ITimeRangePickerProps> {
    ...
    return (
      <section className={`${styles.timeRangePicker} ${hasTeamsContext ? styles.teams : ''}`}>
